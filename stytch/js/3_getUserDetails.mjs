...
processCSV({
  ...
  projectId: 'project-test-36510638-652a-4d3d-9a94-f0a7106582fc',
  secretKey: 'secret-test-Ww5WZPWzBGJdW44BOCq3K6VypSyjC8iO4dE='
});

async function processCSV(p) {
  const client = new stytch.Client({project_id: p.projectId, secret: p.secretKey});
